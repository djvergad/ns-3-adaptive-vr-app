 ...
 *
 */
#ifndef VR_ADAPTiVE_BURSTY_HELPER_H
#define VR_ADAPTiVE_BURSTY_HELPER_H
...
public:
   ...
   *        to.
   */
  VrAdaptiveBurstyHelper (std::string protocol, Address address);
   ...
   */
  void SetBurstGenerator (std::string type, std::string n1 = "",
...
#endif /* VR_ADAPTiVE_BURSTY_HELPER_H */
